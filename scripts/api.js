(function() {
	...
	var a = this, c = b.modules = [], d = b.cache = [];
	c[0] = function(a, b, c) {
		function J(a) {
			...
			if (!!a) {
				...
				if (d && d.instance)
					return d.instance;
				var e = m.indexOf(s(a)) > -1, f = new F(a);
				l.push(new E(f, a, e));
				return f
			}
		}
		...
		function z(a, b) {
			return function(c) {
				var d = o(c), e = x(this), f = !d && b ? c : null, g = d && !b ? c : null;
		...
		function w(a, b, c) {
			...
			if (!d.postMessage)
				return !1;
			var e = c.getAttribute("src").split("?")[0], f = JSON.stringify({
				method : a,
				value : b
			});
		...
		var d = this, e = c(1), f = c(2), g = c(3), h = e.bridge, i = e.api, j = "http://wt.soundcloud.com/player/", k = "__LATE_BINDING__", l = [], m = [], E = function(a, b, c) {
			...
			load : function(a, b) {
				if (!!a) {
					b = b || {};
					var c = this, d = x(this), e = d.element, f = e.src, g = f.substr(0, f.indexOf("?"));
